DROP DATABASE IF EXISTS SamaanResorts;
CREATE DATABASE SamaanResorts;
USE SamaanResorts;
...
INSERT INTO Employee (Employee_ID, First_Name, Last_Name, Sex, DOB, Date_of_Employment, Branch_ID, Department_ID, Position, Home_Address, Email, Phone_Number) VALUES
...
INSERT INTO Customer (Customer_ID, Sex, DOB, Customer_Type, First_Name, Last_Name, Email, Phone_Number) VALUES
...
INSERT INTO Room (Room_ID, Room_Name, Room_Type, Price, Room_Status, Branch_ID) VALUES
...
INSERT INTO Room_Booking (Room_Booking_ID, Customer_ID, Room_ID, Check_In_Date, Check_Out_Date, Requests) VALUES
...
('RB006', 'C006', 'R006', '2024-07-06 16:00:00', '2024-07-10 12:00:00', 'Extra towels'),
('RB007', 'C007', 'R018', '2024-07-07 14:00:00', '2024-07-11 11:00:00', 'Late check-out'),
('RB008', 'C008', 'R019', '2024-07-08 15:00:00', '2024-07-12 10:00:00', 'Airport transfer'),
('RB009', 'C009', 'R020', '2024-07-09 13:00:00', '2024-07-13 12:00:00', 'Breakfast in room'),
('RB010', 'C010', 'R010', '2024-07-10 14:00:00', '2024-07-14 11:00:00', 'Spa appointment');

INSERT INTO Facilities (Facility_ID, Facility_Name, Branch_ID, Facility_Head) VALUES
...
INSERT INTO Service (Service_ID, Service_Name, Price, Facility_ID) VALUES
...
INSERT INTO Service_Booking (Service_Booking_ID, Service_ID, Price, Customer_ID, Employee_ID, Check_In_Time, Check_Out_Time, Branch_ID, Requests) VALUES
...
INSERT INTO Room_Billing (RBilling_ID, Room_Booking_ID, Payment_Status, Payment_Date, Payment_Method) VALUES
...
INSERT INTO Service_Billing (SBilling_ID, Service_Booking_ID, Amount, Payment_Status, Payment_Date, Payment_Method) VALUES
...
-- MySQL does not accept the full outer join syntax
-- Get all rooms and their booking statuses 
SELECT Room.Room_ID, Room.Room_Name, 
Room.Room_Type, Room.Price, Room.Room_Status, 
Room.Branch_ID, Room_Booking.Room_Booking_ID, 
...
-- Get all customers and their room billing details 
...
ORDER BY c.Customer_ID;  -- Order by Customer_ID
...
JOIN 
    Room_Booking ON Room.Room_ID = Room_Booking.Room_ID
JOIN 
    Room_Billing ON Room_Booking.Room_Booking_ID = Room_Billing.Room_Booking_ID
GROUP BY 
    Room.Branch_ID;
...
SELECT e.Employee_ID, e.First_Name, e.Last_Name, e.Position,
    d.Department_Name, d.Department_Head, b.Branch_Name, b.Location
FROM Employee e
INNER JOIN Department d ON e.Department_ID = d.Department_ID  -- Join Employee table with Department table on Department_ID
